...
import com.larkmt.cn.admin.util.PageUtils;
 ...
 **/
@RestController
@RequestMapping("/larkmidtable/api/jobRegistry")
@Api(tags = "执行器资源监控")
public class JobRegistryController extends BaseController {
    ...
    public R<IPage<JobRegistry>> selectAll() {
        ...
        return success(jobRegistryService.page(baseForm.getPlusPagingQueryEntity(), pageQueryWrapperCustom(baseForm.getParameters())));
    }
